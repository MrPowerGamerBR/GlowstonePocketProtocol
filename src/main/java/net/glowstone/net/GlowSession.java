...
import net.pocketdreams.sequinland.glowstone.net.message.DisconnectPacket;
...
public class GlowSession extends BasicSession {
     ...
     */
    protected boolean compresssionSent;
    ...
    public void disconnect(String reason, boolean overrideKick) {
        ...
        if (isActive() && (getProtocol() instanceof LoginProtocol || getProtocol() instanceof PlayProtocol)) {
            ...
            if (this instanceof GlowPocketSession) {
                ((GlowPocketSession) this).sendPocket(new DisconnectPacket(false, reason).andEncode());
            } else {
